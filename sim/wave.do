...
add wave -noupdate -expand -group {APB Slave 0} -label psel_0 -format Logic /test_bench/i_apb_if/psel_0
add wave -noupdate -expand -group {APB Slave 0} -label penable -format Logic /test_bench/i_apb_if/penable
add wave -noupdate -expand -group {APB Slave 0} -label pwrite -format Logic /test_bench/i_apb_if/pwrite
add wave -noupdate -expand -group {APB Slave 0} -label paddr -format Literal -radix hexadecimal /test_bench/i_apb_if/paddr
add wave -noupdate -expand -group {APB Slave 0} -label pwdata -format Literal -radix hexadecimal /test_bench/i_apb_if/pwdata
add wave -noupdate -expand -group {APB Slave 0} -label prdata_0 -format Literal -radix hexadecimal /test_bench/i_apb_if/prdata_0
add wave -noupdate -expand -group {APB Slave 0} -label pready_0 -format Logic /test_bench/i_apb_if/pready_0
add wave -noupdate -expand -group {APB Slave 0} -label pslverr_0 -format Logic /test_bench/i_apb_if/pslverr_0
